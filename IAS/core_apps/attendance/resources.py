...
class AttendanceResource(resources.ModelResource):
    ...
    class Meta:
        model = Attendance
        fields = (
            "a_type", "a_date", "in_time", "out_time", "a_status", 
            "user_name", "user_email", "user_identifier", "class_identifier" # "created_by_name"
        )
    ...
    def dehydrate_class_identifier(self, obj):
        ...
        if obj.a_type == RoleType.STUDENT and obj.academic_info and obj.academic_info.student:
            return f"{obj.academic_info.academic_class_section.class_name} - {obj.academic_info.academic_class_section.class_name}"
        return "N/A"
