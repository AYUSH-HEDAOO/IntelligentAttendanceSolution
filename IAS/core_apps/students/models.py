...
from ias.core_apps.common.models import IASModel, AttendanceStatus, BloodGroup, Gender
...
class Student(IASModel):
    ...
    profile_image = models.ImageField(blank=True, default="/profile_images/default_profile.png", upload_to=student_directory_path)
